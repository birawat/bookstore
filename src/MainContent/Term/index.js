...
<p>General: The site gives you limited license through which you can access the personal use of the website for downloading or modifying any portion of the content without the consent of the site.
...
Use of Metatags: You are not permitted to use metatags or hidden texts for utilizing the name or the trademark of the company without any written consent. If you use it, you will be terminated from the permission of licenses that are granted by the company.</p>
<h5>About Your Account</h5>
<p>Protection: As per the privacy policy of the website, you are responsible for maintaining the confidentiality of the account and password you have, so that you can restrict access to your computer. In addition to that, you also accept the responsibility of all the activities that occur under your password.
